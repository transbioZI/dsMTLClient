...
#load data
##########################
datashield.assign.resource(datasources[1],symbol="X",resource = "dsmtlserver1/test/dsMTL_Net_R_X")
datashield.assign.expr(conns = datasources[1],  symbol = "X", expr = quote(as.resource.object(X)))
datashield.assign.resource(datasources[1],symbol="Y",resource = "dsmtlserver1/test/dsMTL_Net_R_Y")
datashield.assign.expr(conns = datasources[1],  symbol = "Y", expr = quote(as.resource.object(Y)))

datashield.assign.resource(datasources[2],symbol="X",resource = "dsmtlserver2/test/dsMTL_Net_R_X")
datashield.assign.expr(conns = datasources[2],  symbol = "X", expr = quote(as.resource.object(X)))
datashield.assign.resource(datasources[2],symbol="Y",resource = "dsmtlserver2/test/dsMTL_Net_R_Y")
...
#load data
##########################
datashield.assign.resource(datasources[1],symbol="X",resource = "dsmtlserver1/test/dsMTL_Net_C_X")
datashield.assign.expr(conns = datasources[1],  symbol = "X", expr = quote(as.resource.object(X)))
datashield.assign.resource(datasources[1],symbol="Y",resource = "dsmtlserver1/test/dsMTL_Net_C_Y")
datashield.assign.expr(conns = datasources[1],  symbol = "Y", expr = quote(as.resource.object(Y)))

datashield.assign.resource(datasources[2],symbol="X",resource = "dsmtlserver2/test/dsMTL_Net_C_X")
datashield.assign.expr(conns = datasources[2],  symbol = "X", expr = quote(as.resource.object(X)))
datashield.assign.resource(datasources[2],symbol="Y",resource = "dsmtlserver2/test/dsMTL_Net_C_Y")
datashield.assign.expr(conns = datasources[2],  symbol = "Y", expr = quote(as.resource.object(Y)))
X="X"; Y="Y"; G=matrix(c(1,-1), 2,1)
